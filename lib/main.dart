                      ...
                      Column(
                        children: <Widget>[
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: const DecorationImage(
                                image: NetworkImage("https://jrm.org.zw/wp-content/uploads/2024/06/PRAYER-RETREAT-2024-THUMBNAIL.png"),
                                fit: BoxFit.cover
                              ),
                              border: Border.all(
                                  color: const Color(Config.colorGold),
                            ...
                            child: Stack(
                              ...
                              children: <Widget>[
                                Container(
                                  ...
                                  height: 150.0,
                                  decoration: BoxDecoration(
                                    color: const Color(Config.colorBlack).withOpacity(0.5),
                                    borderRadius: BorderRadius.circular(Config.defaultPadding)
                                  ),
                                ),
                                Padding(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: const DecorationImage(
                                  image: NetworkImage("https://jrm.org.zw/wp-content/uploads/2024/06/Ladies-Fellowship-2024.png"),
                                  fit: BoxFit.cover
                              ),
                              border: Border.all(
                                  color: const Color(Config.colorGold),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: const DecorationImage(
                                  image: NetworkImage("https://jrm.org.zw/wp-content/uploads/2017/01/Mens-Fellowship.png"),
                                  fit: BoxFit.cover
                              ),
                              border: Border.all(
                                  color: const Color(Config.colorGold),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: const DecorationImage(
                                  image: NetworkImage("https://jrm.org.zw/wp-content/uploads/2024/06/Revelation-Gathering-2of2024-Final.png"),
                                  fit: BoxFit.cover
                              ),
                              border: Border.all(
                                  color: const Color(Config.colorGold),
          ...
          bottomNavigationBar: BottomNavigationBar (
            items: const <BottomNavigationBarItem>[
              BottomNavigationBarItem(
                ...
                label: "Home",
                backgroundColor: Color(Config.colorPurple),
              ),
              BottomNavigationBarItem(
